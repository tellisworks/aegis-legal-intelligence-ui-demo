...
const documentDatabase: DocumentItem[] = [
  {
    ...
    description: "Email from Respondent stating they will not attend the psychological evaluation appointment",
  ...
  },
  {
    ...
    description: "47 consecutive text messages from Petitioner to Respondent with no responses over 17-day period",
  ...
  },
  {
    ...
    description: "Respondent's original contempt filing containing claims of exclusion from evaluation",
  ...
  },
  {
    ...
    description: "Email exchanges between Respondent and school blocking father's access to information",
