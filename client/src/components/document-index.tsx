...
const documentDatabase: DocumentItem[] = [
  {
    ...
    description: "Email from Mae Igi stating she will not attend the psychological evaluation appointment",
  ...
  },
  {
    ...
    description: "47 consecutive text messages from Tom to Mae with no responses over 17-day period",
  ...
  },
  {
    ...
    description: "Mae's original contempt filing containing claims of exclusion from evaluation",
  ...
  },
  {
    ...
    description: "Email exchanges between Mae and school blocking father's access to information",
    source: "Westfield Elementary School",
